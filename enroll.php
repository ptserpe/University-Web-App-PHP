...
if(mysqli_num_rows($result) > 0) {
  echo "<center><h2><b>List of all courses</b></h2> <br>";
  echo "<table>";
...
<button onclick="document.getElementById('id01').style.display='block'" ><b>Fill the form with the course you would like to enroll in</b></button>

<div id="id01" class="modal">
  <form class ="modal-content animate" method = "get" action = "insert_enrolled.php">
    <div class="container">
      ...
      <div class="container">
        ...
        <br>
        <label for="title"><b>Enter title of course </b></label>
        <br>
